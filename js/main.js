...
(function() {
  ...
  $(function() {
    var WinningTileValue, addScore, arrayEqual, boardEqual, boardFull, buildBoard, collapseCells, colorCode, gameLost, gameWon, generateTile, getColumn, getRandomCell, getRow, mergeCells, move, moveIsValid, noValidMoves, ppArray, randomInt, randomValue, setColumn, setRow, setScoreZero, showBoard, x, y, _i, _j;
