...
(function() {
  $(function() {
    var a1, a2, a3, a4, boardFull, cells, collapseCells, completeResult, generateTile, getColumn, getRandomCell, getRow, masterArray, mergeCells, ppArray, randomInt, randomValue, result, x, y, _i, _j;
    ...
    masterArray = function() {
      return masterArray = [a1, a2, a3, a4];
    };
    masterArray();
    ...
    return console.log(completeResult);
  });
